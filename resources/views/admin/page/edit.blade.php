                    ...
                    <div class="card-body">
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content_de" class="my-editor" id="content_de" cols="30" rows="10">{{ $page->content_de }}</textarea>
                            ...
                            <div class="row" style="margin-top: 15px">
                             ...
                             <div class="row" style="margin-top: 15px">
                                <div class="col-md-6">
                                    ...
                                    <textarea name="meta_title_de" class="form-control" id="meta_title_de" cols="30" rows="5">{{ $page->meta_title_de}}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="meta_description_de" class="form-control" id="meta_description_de" cols="30" rows="5">{{ $page->meta_description_de }}</textarea>
