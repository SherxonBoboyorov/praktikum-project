...
@section('content')
    <div class="page-content-wrapper ">
        ...
        <div class="container-fluid">
            ...
            <form action="{{ route('employer.store') }}" enctype="multipart/form-data" method="POST">
                @csrf
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="applicants_de" class="my-editor" id="applicants_de" cols="30" rows="10"></textarea>
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="applicants_en" class="my-editor" id="applicants_en" cols="30" rows="10"></textarea>
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="services_de" class="my-editor" id="services_de" cols="30" rows="10"></textarea>
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="services_en" class="my-editor" id="services_en" cols="30" rows="10"></textarea>
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="conditions_de" class="my-editor" id="conditions_de" cols="30" rows="10"></textarea>
                            ...
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    ...
                                    <textarea name="conditions_en" class="my-editor" id="conditions_en" cols="30" rows="10"></textarea>
